<template>
  <form @submit.prevent="submitRegisterDetails">
    <h1 class="display-4 mb-10">Sign up for Industry</h1>
    ...
    <div class="form-group">
      <input class="form-control" v-model="user.company" placeholder="Company" type="text" />
    </div>
    <div class="form-group">
...
export default {
  ...
  methods: {
    submitRegisterDetails() {
      //add
      fetch("api/auth/registerindustry", {
        method: "post",
